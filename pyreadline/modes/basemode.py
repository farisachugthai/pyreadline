...
####################################
    ...
    def rl_settings_to_string(self):
        ...
        bindings = [(k[0], k[1], k[2], k[3], v.__name__)
    ...
    def _bind_key(self, key, func):
        ...
        if not callable(func):
            ...
            raise ReadlineError("Trying to bind non method to keystroke:%s,%s,%s,%s" % (
...
#   Paste from clipboard
    ...
    def ipython_paste(self, e):
        ...
        If enable_ipython_paste_list_of_lists is True then try to convert
        tabseparated data to repr of list of lists or repr of array.

        If enable_ipython_paste_for_paths==True then change \\ to / and spaces to an escaped space.
        """
        if self.enable_win32_clipboard:
